...
function registerIpcHandlers(createEditorWindow, createSourceSelectorWindow, getMainWindow, getSourceSelectorWindow, onRecordingStateChange) {
  ...
  ipcMain.handle("store-recorded-video", async (_, videoData, fileName) => {
    try {
      ...
      console.error(...oo_tx(`805845681_79_6_79_52_11`, "Failed to store video:", error));
      return {
        success: false,
  ...
  ipcMain.handle("store-cursor-data", async (_, videoPath, cursorData) => {
    try {
      ...
      console.error(...oo_tx(`805845681_95_6_95_58_11`, "Failed to store cursor data:", error));
  ...
  ipcMain.handle("save-project", async (_, projectData, suggestedFileName) => {
    try {
      ...
      console.error(...oo_tx(`805845681_138_6_138_53_11`, "Failed to save project:", error));
      return {
        success: false,
  ...
  ipcMain.handle("load-project", async (_, projectPath) => {
    try {
      ...
      console.error(...oo_tx(`805845681_152_6_152_53_11`, "Failed to load project:", error));
      return {
        success: false,
  ...
  ipcMain.handle("open-project-file-picker", async () => {
    try {
      ...
      console.error(...oo_tx(`805845681_182_6_182_60_11`, "Failed to open project picker:", error));
      return {
        success: false,
  ...
  ipcMain.handle("get-recorded-video-path", async () => {
    try {
      ...
      console.error(...oo_tx(`805845681_214_6_214_55_11`, "Failed to get video path:", error));
  ...
  function startGlobalMouseListener(window) {
    ...
    globalMouseListenerInterval = setInterval(() => {
      ...
      try {
        ...
        console.error(...oo_tx(`805845681_284_8_284_63_11`, "Error in global mouse listener:", error));
      }
    }, 1e3 / 60);
  }
  ...
  ipcMain.handle("open-external-url", async (_, url) => {
    try {
      ...
      console.error(...oo_tx(`805845681_304_6_304_49_11`, "Failed to open URL:", error));
  ...
  ipcMain.handle("get-asset-base-path", () => {
    try {
      ...
      console.error(...oo_tx(`805845681_317_6_317_62_11`, "Failed to resolve asset base path:", err));
      return null;
    }
  });
  ipcMain.handle("save-exported-video", async (_, videoData, fileName) => {
    try {
      ...
      console.error(...oo_tx(`805845681_352_6_352_60_11`, "Failed to save exported video:", error));
      return {
        success: false,
  ...
  ipcMain.handle("open-video-file-picker", async () => {
    try {
      ...
      console.error(...oo_tx(`805845681_382_6_382_57_11`, "Failed to open file picker:", error));
      return {
        success: false,
  ...
  ipcMain.handle("open-video-files-picker", async () => {
    try {
      ...
      console.error(...oo_tx(`805845681_412_6_412_58_11`, "Failed to open files picker:", error));
      return {
        success: false,
  ...
  ipcMain.handle("get-source-bounds", async () => {
    try {
      ...
      console.error(...oo_tx(`805845681_528_6_528_58_11`, "Failed to get source bounds:", error));
      return {
        success: false,
