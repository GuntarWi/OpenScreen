...
function registerIpcHandlers(createEditorWindow, createSourceSelectorWindow, getMainWindow, getSourceSelectorWindow, onRecordingStateChange) {
  ...
  ipcMain.handle("store-recorded-video", async (_, videoData, fileName) => {
    try {
      ...
      console.error(...oo_tx(`1915027710_75_6_75_52_11`, "Failed to store video:", error));
      return {
        success: false,
  ...
  ipcMain.handle("store-cursor-data", async (_, videoPath, cursorData) => {
    try {
      ...
      console.error(...oo_tx(`1915027710_91_6_91_58_11`, "Failed to store cursor data:", error));
  ...
  ipcMain.handle("save-project", async (_, projectData, suggestedFileName) => {
    try {
      ...
      console.error(...oo_tx(`1915027710_130_6_130_53_11`, "Failed to save project:", error));
      return {
        success: false,
  ...
  ipcMain.handle("load-project", async (_, projectPath) => {
    try {
      ...
      console.error(...oo_tx(`1915027710_144_6_144_53_11`, "Failed to load project:", error));
      return {
        success: false,
  ...
  ipcMain.handle("open-project-file-picker", async () => {
    try {
      ...
      console.error(...oo_tx(`1915027710_174_6_174_60_11`, "Failed to open project picker:", error));
      return {
        success: false,
  ...
  ipcMain.handle("get-recorded-video-path", async () => {
    try {
      ...
      console.error(...oo_tx(`1915027710_206_6_206_55_11`, "Failed to get video path:", error));
  ...
  function startGlobalMouseListener(window) {
    ...
    globalMouseListenerInterval = setInterval(() => {
      ...
      try {
        ...
        console.error(...oo_tx(`1915027710_276_8_276_63_11`, "Error in global mouse listener:", error));
      }
    }, 1e3 / 60);
  }
  ...
  ipcMain.handle("open-external-url", async (_, url) => {
    try {
      ...
      console.error(...oo_tx(`1915027710_296_6_296_49_11`, "Failed to open URL:", error));
  ...
  ipcMain.handle("get-asset-base-path", () => {
    try {
      ...
      console.error(...oo_tx(`1915027710_309_6_309_62_11`, "Failed to resolve asset base path:", err));
      return null;
    }
  });
  ipcMain.handle("save-exported-video", async (_, videoData, fileName) => {
    try {
      ...
      console.error(...oo_tx(`1915027710_340_6_340_60_11`, "Failed to save exported video:", error));
      return {
        success: false,
  ...
  ipcMain.handle("open-video-file-picker", async () => {
    try {
      ...
      console.error(...oo_tx(`1915027710_370_6_370_57_11`, "Failed to open file picker:", error));
      return {
        success: false,
  ...
  ipcMain.handle("get-source-bounds", async () => {
    try {
      ...
      console.error(...oo_tx(`1915027710_471_6_471_58_11`, "Failed to get source bounds:", error));
      return {
        success: false,
