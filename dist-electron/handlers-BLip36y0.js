...
function registerIpcHandlers(createEditorWindow, createSourceSelectorWindow, getMainWindow, getSourceSelectorWindow, onRecordingStateChange) {
  ...
  ipcMain.handle("store-recorded-video", async (_, videoData, fileName) => {
    try {
      ...
      console.error(...oo_tx(`3505874654_75_6_75_52_11`, "Failed to store video:", error));
      return {
        success: false,
  ...
  ipcMain.handle("store-cursor-data", async (_, videoPath, cursorData) => {
    try {
      ...
      console.error(...oo_tx(`3505874654_91_6_91_58_11`, "Failed to store cursor data:", error));
  ...
  ipcMain.handle("get-recorded-video-path", async () => {
    try {
      ...
      console.error(...oo_tx(`3505874654_122_6_122_55_11`, "Failed to get video path:", error));
  ...
  function startGlobalMouseListener(window) {
    ...
    globalMouseListenerInterval = setInterval(() => {
      ...
      try {
        ...
        console.error(...oo_tx(`3505874654_192_8_192_63_11`, "Error in global mouse listener:", error));
      }
    }, 1e3 / 60);
  }
  ...
  ipcMain.handle("open-external-url", async (_, url) => {
    try {
      ...
      console.error(...oo_tx(`3505874654_212_6_212_49_11`, "Failed to open URL:", error));
  ...
  ipcMain.handle("get-asset-base-path", () => {
    try {
      ...
      console.error(...oo_tx(`3505874654_225_6_225_62_11`, "Failed to resolve asset base path:", err));
      return null;
    }
  });
  ipcMain.handle("save-exported-video", async (_, videoData, fileName) => {
    try {
      ...
      console.error(...oo_tx(`3505874654_256_6_256_60_11`, "Failed to save exported video:", error));
      return {
        success: false,
  ...
  ipcMain.handle("open-video-file-picker", async () => {
    try {
      ...
      console.error(...oo_tx(`3505874654_286_6_286_57_11`, "Failed to open file picker:", error));
      return {
        success: false,
  ...
  ipcMain.handle("get-source-bounds", async () => {
    try {
      ...
      console.error(...oo_tx(`3505874654_387_6_387_58_11`, "Failed to get source bounds:", error));
      return {
        success: false,
