...
function registerIpcHandlers(createEditorWindow, createSourceSelectorWindow, getMainWindow, getSourceSelectorWindow, onRecordingStateChange) {
  ...
  ipcMain.handle("store-recorded-video", async (_, videoData, fileName) => {
    try {
      ...
      console.error(...oo_tx(`2558432588_80_6_80_52_11`, "Failed to store video:", error));
      return {
        success: false,
  ...
  ipcMain.handle("store-cursor-data", async (_, videoPath, cursorData) => {
    try {
      ...
      console.error(...oo_tx(`2558432588_96_6_96_58_11`, "Failed to store cursor data:", error));
  ...
  ipcMain.handle("save-project", async (_, projectData, suggestedFileName) => {
    try {
      ...
      console.error(...oo_tx(`2558432588_139_6_139_53_11`, "Failed to save project:", error));
      return {
        success: false,
  ...
  ipcMain.handle("load-project", async (_, projectPath) => {
    try {
      ...
      console.error(...oo_tx(`2558432588_153_6_153_53_11`, "Failed to load project:", error));
      return {
        success: false,
  ...
  ipcMain.handle("open-project-file-picker", async () => {
    try {
      ...
      console.error(...oo_tx(`2558432588_183_6_183_60_11`, "Failed to open project picker:", error));
      return {
        success: false,
  ...
  ipcMain.handle("get-recorded-video-path", async () => {
    try {
      ...
      console.error(...oo_tx(`2558432588_215_6_215_55_11`, "Failed to get video path:", error));
  ...
  function startGlobalMouseListener(window) {
    ...
    globalMouseListenerInterval = setInterval(() => {
      ...
      try {
        ...
        console.error(...oo_tx(`2558432588_285_8_285_63_11`, "Error in global mouse listener:", error));
      }
    }, 1e3 / 60);
  }
  ...
  ipcMain.handle("open-external-url", async (_, url) => {
    try {
      ...
      console.error(...oo_tx(`2558432588_305_6_305_49_11`, "Failed to open URL:", error));
  ...
  ipcMain.handle("get-asset-base-path", () => {
    try {
      ...
      console.error(...oo_tx(`2558432588_318_6_318_62_11`, "Failed to resolve asset base path:", err));
      return null;
    }
  });
  ipcMain.handle("save-exported-video", async (_, videoData, fileName) => {
    try {
      ...
      console.error(...oo_tx(`2558432588_353_6_353_60_11`, "Failed to save exported video:", error));
      return {
        success: false,
  ...
  ipcMain.handle("open-video-file-picker", async () => {
    try {
      ...
      console.error(...oo_tx(`2558432588_383_6_383_57_11`, "Failed to open file picker:", error));
      return {
        success: false,
  ...
  ipcMain.handle("get-source-bounds", async () => {
    try {
      ...
      console.error(...oo_tx(`2558432588_484_6_484_58_11`, "Failed to get source bounds:", error));
      return {
        success: false,
