...
function registerIpcHandlers(createEditorWindow, createSourceSelectorWindow, getMainWindow, getSourceSelectorWindow, onRecordingStateChange) {
  ...
  ipcMain.handle("store-recorded-video", async (_, videoData, fileName) => {
    try {
      ...
      console.error(...oo_tx(`630729142_75_6_75_52_11`, "Failed to store video:", error));
      return {
        success: false,
  ...
  ipcMain.handle("store-cursor-data", async (_, videoPath, cursorData) => {
    try {
      ...
      console.error(...oo_tx(`630729142_91_6_91_58_11`, "Failed to store cursor data:", error));
  ...
  ipcMain.handle("save-project", async (_, projectData, suggestedFileName) => {
    try {
      ...
      console.error(...oo_tx(`630729142_134_6_134_53_11`, "Failed to save project:", error));
      return {
        success: false,
  ...
  ipcMain.handle("load-project", async (_, projectPath) => {
    try {
      ...
      console.error(...oo_tx(`630729142_148_6_148_53_11`, "Failed to load project:", error));
      return {
        success: false,
  ...
  ipcMain.handle("open-project-file-picker", async () => {
    try {
      ...
      console.error(...oo_tx(`630729142_178_6_178_60_11`, "Failed to open project picker:", error));
      return {
        success: false,
  ...
  ipcMain.handle("get-recorded-video-path", async () => {
    try {
      ...
      console.error(...oo_tx(`630729142_210_6_210_55_11`, "Failed to get video path:", error));
  ...
  function startGlobalMouseListener(window) {
    ...
    globalMouseListenerInterval = setInterval(() => {
      ...
      try {
        ...
        console.error(...oo_tx(`630729142_280_8_280_63_11`, "Error in global mouse listener:", error));
      }
    }, 1e3 / 60);
  }
  ...
  ipcMain.handle("open-external-url", async (_, url) => {
    try {
      ...
      console.error(...oo_tx(`630729142_300_6_300_49_11`, "Failed to open URL:", error));
  ...
  ipcMain.handle("get-asset-base-path", () => {
    try {
      ...
      console.error(...oo_tx(`630729142_313_6_313_62_11`, "Failed to resolve asset base path:", err));
      return null;
    }
  });
  ipcMain.handle("save-exported-video", async (_, videoData, fileName) => {
    try {
      ...
      console.error(...oo_tx(`630729142_348_6_348_60_11`, "Failed to save exported video:", error));
      return {
        success: false,
  ...
  ipcMain.handle("open-video-file-picker", async () => {
    try {
      ...
      console.error(...oo_tx(`630729142_378_6_378_57_11`, "Failed to open file picker:", error));
      return {
        success: false,
  ...
  ipcMain.handle("get-source-bounds", async () => {
    try {
      ...
      console.error(...oo_tx(`630729142_479_6_479_58_11`, "Failed to get source bounds:", error));
      return {
        success: false,
