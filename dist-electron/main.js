...
function registerIpcHandlers(createEditorWindow2, createSourceSelectorWindow2, getMainWindow, getSourceSelectorWindow, onRecordingStateChange) {
  ...
  ipcMain.handle("store-recorded-video", async (_, videoData, fileName) => {
    try {
      ...
      console.error(...oo_tx$1(`3285405761_73_6_73_52_11`, "Failed to store video:", error));
      return {
        success: false,
  ...
  ipcMain.handle("store-cursor-data", async (_, videoPath, cursorData) => {
    try {
      ...
      console.error(...oo_tx$1(`3285405761_89_6_89_58_11`, "Failed to store cursor data:", error));
  ...
  ipcMain.handle("get-recorded-video-path", async () => {
    try {
      ...
      console.error(...oo_tx$1(`3285405761_120_6_120_55_11`, "Failed to get video path:", error));
  ...
  function startGlobalMouseListener(window) {
    ...
    globalMouseListenerInterval = setInterval(() => {
      ...
      try {
        ...
        console.error(...oo_tx$1(`3285405761_190_8_190_63_11`, "Error in global mouse listener:", error));
      }
    }, 1e3 / 60);
  }
  ...
  ipcMain.handle("open-external-url", async (_, url) => {
    try {
      ...
      console.error(...oo_tx$1(`3285405761_210_6_210_49_11`, "Failed to open URL:", error));
  ...
  ipcMain.handle("get-asset-base-path", () => {
    try {
      ...
      console.error(...oo_tx$1(`3285405761_223_6_223_62_11`, "Failed to resolve asset base path:", err));
      return null;
    }
  });
  ipcMain.handle("save-exported-video", async (_, videoData, fileName) => {
    try {
      ...
      console.error(...oo_tx$1(`3285405761_254_6_254_60_11`, "Failed to save exported video:", error));
      return {
        success: false,
  ...
  ipcMain.handle("open-video-file-picker", async () => {
    try {
      ...
      console.error(...oo_tx$1(`3285405761_284_6_284_57_11`, "Failed to open file picker:", error));
      return {
        success: false,
  ...
  ipcMain.handle("get-source-bounds", async () => {
    try {
      ...
      console.error(...oo_tx$1(`3285405761_385_6_385_58_11`, "Failed to get source bounds:", error));
      return {
        success: false,
...
async function ensureRecordingsDir() {
  try {
    ...
    console.log(...oo_oo(`3928169731_17_4_17_50_4`, "RECORDINGS_DIR:", RECORDINGS_DIR));
    console.log(...oo_oo(`3928169731_18_4_18_59_4`, "User Data Path:", app.getPath("userData")));
  } catch (error) {
    console.error(...oo_tx(`3928169731_20_4_20_66_11`, "Failed to create recordings directory:", error));
  }
}
